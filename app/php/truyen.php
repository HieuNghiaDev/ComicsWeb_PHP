...
<head>
    ...
    <link rel="stylesheet" href="../../public/assets/css/truyen.css">
    <title>Truyen</title>
</head>
                        ...
                        <li>
                            ...
                            if (isset($_SESSION['dangnhap']['username'])) {
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="dangxuat.php"><i class="fa-solid fa-arrow-right-from-bracket"></i> Đăng
                                            Xuất </a></li>
                                </ul>
                                <?php
                            } else {
            ...
            <div class="dtop">
                <div class="right">
                    <table class="table-right">
                        <tr class="tentr">
                            <td class="tentr"><a href="?id=<?= $row['id'] ?>" class="tentr"><?php echo $row['name'] ?></a>
                            </td>
                        </tr>
                        <tr>
                        ...
                        while ($row_sub = mysqli_fetch_array($result_sub)) {
                            ...
                            <a href="truyen.php?id=<?= $row['id'] ?>">
                                <table class="truyen-dx">
                                    <tr>
                                        <td><img src="..\..\public\uploads\comics\<?php echo $row_sub['anh'] ?>" alt="loi anh">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><a href="truyen.php?id=<?= $row_sub['id'] ?>"
                                                class="tentr-dx"><?php echo $row_sub['name'] ?></a></td>
                                    </tr>
                                    <table>
                            </a>
                            <?php
