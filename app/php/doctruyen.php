...
<head>
    ...
    <link rel="stylesheet" href="../../public/assets/css/doctruyen.css">
...
<body>
    <div id="header">
        <nav class="container">
            <div class="brand">
                <span>
                    <a href="index.php"><img class="logo" src="..\..\public\images\logo.png" alt="Lỗi Ảnh"></a>
                </span>
            </div>
            <div class="navbar">
                <div class="searchbox">
                    <form method="post" name="truyen" action="timkiem.php">
                        ...
                        <button class="button" type="submit" name="tim"><i
                ...
                <ul id="header-menu">
                    ...
                    <li>
                        ...
                        if (isset($_SESSION['dangnhap']['username'])) {
                            ?>
                            <div class="avt"><img src="..\..\public\uploads\avatar\<?php echo $row_nd['avt'] ?>"
                                    alt="loi anh"></div>
                            <ul class="sub-menu">
                                <li><a href="toi.php?username=<?= $username ?>"><i class="fa-solid fa-user"></i>
                                        <?php echo $row_nd['fullname']; ?></a></li>
                                <li><a href="dangxuat.php"><i class="fa-solid fa-arrow-right-from-bracket"></i> Đăng Xuất
                                    </a></li>
                            </ul>
                            <?php
                        } else {
                            ?>
                            <div class="avt"><img src="..\..\public\uploads\avatar\avt.png" alt="loi anh"></div>
                            <ul class="sub-menu">
            ...
            if (isset($_SESSION['dangnhap']['username'])) {
                ...
                <tbody>
                    ...
                    while ($rowd = mysqli_fetch_array($resultd)) {
                        ...
                        ?>
                        <div class="anhchap">
                            <img src="..\..\public\uploads\chap\<?php echo $rowd['anh'] ?>" alt="loi anh">
                        </div>
                    <?php } ?>
                </tbody>
                <?php
        ...
        <div class="buttons">
            <div class="chap-selector">
                <select id="chap-select"
                    onchange="location.href='doctruyen.php?id=<?php echo $id ?>&chap=' + this.value">
                    <?php
                    for ($i = 1; $i <= $maxchap; $i++) {
            ...
            <?php if ($prev_chap >= 1) { ?>
                <button type="button"
                    onclick="location.href='doctruyen.php?id=<?php echo $id ?>&chap=<?php echo $prev_chap ?>'">Chap
                    trước</button>
            <?php } ?>
            <?php if ($next_chap <= $maxchap) { ?>
                <button type="button"
                    onclick="location.href='doctruyen.php?id=<?php echo $id ?>&chap=<?php echo $next_chap ?>'">Chap tiếp
                    theo</button>
            <?php } ?>
        </div>
        <div class="comment-section">
            <div class="comment-input">
                <textarea name="cmt" id="cmt"
                    placeholder="Nhập vào khung này nếu bạn muốn bình luận cho bộ truyện này.."></textarea>
