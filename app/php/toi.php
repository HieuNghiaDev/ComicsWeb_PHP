...
<head>
    ...
    <link rel="stylesheet" href="../../public/assets/css/toi.css">
...
<body>
                ...
                <ul id="header-menu">
                    ...
                    <li>
                        ...
                        if (isset($_SESSION['dangnhap']['username'])) {
                            ?>
                            <div class="avt"><img src="..\..\public\uploads\avatar\<?php echo $row['avt'] ?>" alt="loi anh">
                            </div>
                            <ul class="sub-menu">
    ...
    <div class="profile-container">
        <div class="profile-info">
            <img src="..\..\public\uploads\avatar\<?php echo $row['avt'] ?>" alt="Avatar">
            ...
            <form action="" method="POST" name="frmadd" enctype="multipart/form-data">
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <input class="username" type="text" name="username" value="<?= $row['username'] ?>"
                                readonly>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input class="fullname" type="text" name="fullname" value="<?= $row['fullname'] ?>">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input class="password" type="password" name="password" placeholder="Nhập vào mật khẩu">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input class="password" type="password" name="repassword"
