                        ...
                        if (isset($_SESSION['dangnhap']['username'])) {
                            ...
                            if ($quyen == 1) {
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="canhan.php"><i class="fa-solid fa-address-card"></i> Người Sáng Tạo </a>
                                    </li>
                                </ul>
                                <?php
                            } else {
                            ...
                            ?>
                            <div class="avt"><img src="..\..\public\uploads\avatar\" alt="loi anh"></div>
                            <ul class="sub-menu">
                ...
                <div class="story">
                    <a href="truyen.php?id=<?= $row['id'] ?>">
                        <div class="story-image">
                            <img src="..\..\public\uploads\comics\<?php echo $row['anh'] ?>" alt="loi anh">
                        </div>
                    </a>
                </div>
                <?php
        ...
        <div class="left">
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                <a href="truyen.php?id=<?= $row['id'] ?>">
                    <table class="table">
                        <tr>
                            <td><img src="..\..\public\uploads\comics\<?php echo $row['anh'] ?>" alt="loi anh"></td>
                        </tr>
                        <tr>
                    ...
                    foreach ($rows as $data) {
                        ...
                        <a href="truyen.php?id=<?= $row1['id'] ?>">
                            <table class="table_follow">
                                <tr>
                                    <td class="name"><img src="..\..\public\uploads\comics\<?php echo $row1['anh'] ?>"
                                            alt="loi anh"></td>
                                    <td><a href="truyen.php?id=<?= $row1['id'] ?>" class="tentr"><?php echo $row1['name'] ?></a>
                                    </td>
                                </tr>
                            </table>
                        </a>
            ...
            <div class="right-bot">
                ...
                while ($row_cmt = mysqli_fetch_array($result_cmt)) {
                    ...
                    <div class="comment-display">
                        <a href="truyen.php?id=<?= $row_truyen['id'] ?>">
                            <div class="name"><?php echo $row_truyen['name'] ?></div>
                        </a>
