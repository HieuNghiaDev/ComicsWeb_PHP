...
<head>
    ...
    <link rel="stylesheet" href="../../public/assets/css/theodoi.css">
    <title>Truyen</title>
</head>
    ...
    <header>
        <div id="header">
            <nav class="container">
                <div class="brand">
                    <span>
                        <a href="http://localhost/php/ComicsWeb/app/php/index.php"><img class="logo"
                                src="..\..\public\images\logo.png" alt="Lỗi Ảnh"></a>
                    </span>
                </div>
                <div class="navbar">
                    <div class="searchbox">
        ...
        if (isset($_SESSION['dangnhap']['username'])) {
            while ($row = mysqli_fetch_array($query)) {
                ...
                <a href="truyen.php?id=<?= $row1['id'] ?>">
                    <table class="table">
                        <tr>
                            <td><img src="..\..\public\uploads\comics\<?php echo $row1['anh'] ?>" alt="loi anh"></td>
                        </tr>
                        <tr>
                            <td>
