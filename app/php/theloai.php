...
// $sql = "select * from truyen where id = '".$theloai."'";
...
<head>
    ...
    <link rel="stylesheet" href="../../public/assets/css/timkiem.css">
...
<body>
                        ...
                        if (isset($_SESSION['dangnhap']['username'])) {
                            ...
                            <ul class="sub-menu">
                                <li><a href="toi.php?username=<?= $username ?>"><i class="fa-solid fa-user"></i>
                                        <?php echo $_SESSION['dangnhap']['username']; ?></a></li>
    ...
    <tbody>
        <?php
        $sql = "select * from truyen where theloai = '$theloai'";
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            <a href="truyen.php?id=<?= $row['id'] ?>">
                <table class="table">
                    ...
                    <tr>
                        <td><a href="" class="tentr">Thể Loại : <?php echo $row['theloai'] ?></a></td>
                    </tr>
                </table>
            </a>
        <?php } ?>
